...
var marker = L.marker([51.5, -0.09],{draggable:true,autoPan:true}).addTo(mymap);
...
function showPosition(position) {
  ...
  setFields(`https://eu1.locationiq.com/v1/reverse.php?key=pk.44251552e61402067c5e1b4e0c496cc5&lat=${lat}&lon=${long}&format=json`);
